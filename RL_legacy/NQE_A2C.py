...
def plot_nqe_loss(NQE_losses, iter):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig(f'/Users/jwheo/Desktop/Y/NQE/Neural-Quantum-Embedding/RL_legacy/result_plot/NQE_A2C_{iter}th.png')
...
def plot_policy_loss(policy_losses, iter):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig(f'/Users/jwheo/Desktop/Y/NQE/Neural-Quantum-Embedding/RL_legacy/result_plot/Policy_A2C_{iter}th.png')
...
def draw_circuit(action_sequence, iter):
    ...
    if action_sequence is not None:
        ...
        fig.savefig(f'/Users/jwheo/Desktop/Y/NQE/Neural-Quantum-Embedding/RL_legacy/result_plot/RL_circuit_A2C_{iter}th.png', bbox_inches='tight')
...
def plot_comparison(loss_none, loss_NQE, loss_NQE_RL,
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig(f'/Users/jwheo/Desktop/Y/NQE/Neural-Quantum-Embedding/RL_legacy/result_plot/QCNN_A2C.png')
