...
if __name__ == "__main__":
    ...
    plt.savefig('/Users/jwheo/Desktop/Y/NQE/Neural-Quantum-Embedding/RL_legacy/policy_loss_copy.png')
    ...
    torch.save(model_RL.state_dict(), "/RL_legacy/model_RL_copy.pt")
    torch.save(model_ZZ.state_dict(), "/RL_legacy/model_ZZ_copy.pt")
    ...
    model_transform_RL.load_state_dict(
        torch.load("/RL_legacy/model_RL_copy.pt", weights_only=True))
    model_transform_ZZ.load_state_dict(
        torch.load("/RL_legacy/model_ZZ_copy.pt", weights_only=True))
    ...
    fig.savefig('/Users/jwheo/Desktop/Y/NQE/Neural-Quantum-Embedding/RL_legacy/QCNN_loss_history_compare_copy.png')
