...
if __name__ == "__main__":
    ...
    wandb.watch(value_net, log="all", log_freq=1)
    ...
    plot_and_save_trajectory(layer_list_list, filename="trajectory_base_lr05.png", max_epoch_PG=max_epoch_PG, num_layer=num_layer)
